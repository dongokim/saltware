...
/**  
 * @Class Name : AttendedLectureJobImpl.java
 * @Description : 수강과목 Job Implementation
 * @
 * @author kevin
 ...
 */
public class AttendedLectureJobImpl implements Job
{
	private final Log log = LogFactory.getLog(getClass());
	private int timeout;
	
	public AttendedLectureJobImpl()
	{
