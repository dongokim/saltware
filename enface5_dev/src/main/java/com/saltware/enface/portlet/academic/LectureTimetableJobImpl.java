...
/**
 * @Class Name : LectureTimetableJobImpl.java
 * @Description : 강의시간표 Job Implementation @
 * @author kevin
 * @since 2014.03.04 12:58:385
 * @version 1.0
 * @see Copyright (C) by Saltware All right reserved.
 */
public class LectureTimetableJobImpl implements Job {
	private final Log log = LogFactory.getLog(getClass());
	private int timeout;

	public LectureTimetableJobImpl() {
