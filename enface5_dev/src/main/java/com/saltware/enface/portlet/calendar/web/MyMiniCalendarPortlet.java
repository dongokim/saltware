...
/**
 * @Class Name : MyMiniCalendarPortlet.java
 ...
 */
public class MyMiniCalendarPortlet extends CalendarBasePortlet {
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException {
		try {
			...
			List scheduleList = queryForList("calendar.MyOndayScheduleService", userInfo, request.getPreferences());
			...
			List scheduleCountList = queryForList("calendar.MyScheduleCountByMonthService", userInfo, request.getPreferences());
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException {
		...
		if ("scheduleCount".equals(resourceId)) {
