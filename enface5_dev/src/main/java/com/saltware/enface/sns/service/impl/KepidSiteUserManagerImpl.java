...
import com.saltware.enface.user.service.impl.SiteUserManagerImpl;
...
public class KepidSiteUserManagerImpl extends com.saltware.enface.user.service.impl.SiteUserManagerImpl{

	public KepidSiteUserManagerImpl() {
		super();
	}
	...
	public String authenticate( String userId, String password) throws UserException {
		...
		log.info("*** KEPID SiteUserManager authenticate");
	...
	public void syncUsers( Map paramMap) throws BaseException {
		if( paramMap==null) {
			throw new BaseException("paramMap is null");
		}
		PortalConfiguration conf = Enview.getConfiguration();
		...
		String batchDay = (String)paramMap.get("batchDay");
