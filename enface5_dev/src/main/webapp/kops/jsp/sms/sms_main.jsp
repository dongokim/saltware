...
<%
    ...
    String sReturnUrl = reqUrl + reqPath + "/sms/sms_success.jsp?isTest=y";      // 성공시 이동될 URL
    String sErrorUrl = reqUrl + reqPath + "/sms/sms_fail.jsp?isTest=y";          // 실패시 이동될 URL
    
    out.println("1. 성공시 이동될 URL : "+sReturnUrl);
    out.println("2. 실패시 이동될 URL : "+sErrorUrl);
